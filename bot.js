...
client.on("guildMemberRemove", async member => {
 ...
 .setColor("RED")
  ...
  try {
    ...
    giriscikiskanali.send(`:outbox_tray: **__${member.user.tag}__** sunucudan Ayrıldı! **__${sayac[member.guild.id].sayi}__** Kişi Olmamıza **__${sayac[member.guild.id].sayi - member.guild.memberCount}__** Kişi Kaldı. **__${member.guild.members.cache.size}__** Kişiyiz.`);
...
client.on("guildMemberAdd", async member => {
 ...
 .setColor("GREEN")
  ...
  try {
    let giriscikiskanalID = giriscikis[member.guild.id].kanal;
    let giriscikiskanali = client.guilds.cache.get(member.guild.id).channels.cache.get(giriscikiskanalID);
    giriscikiskanali.send(`:inbox_tray: **__${member.user.tag}__** Sunucuya Katıldı! **__${sayac[member.guild.id].sayi}__** Kişi Olmamıza **__${sayac[member.guild.id].sayi - member.guild.memberCount}__** Kişi Kaldı.**__${member.guild.members.cache.size}__** Kişiyiz.` );
  } catch (e) { // eğer hata olursa bu hatayı öğrenmek için hatayı konsola gönderelim.
    return console.log(e)
  }
